/*
FIGYELEM! A vizsga megkezdése elõtt ezt olvassa át.
-	A különbözõ szintekhez (2,3,4,5) a #define makrókat kell állítani 0-ról 1-re.
...
A flotta tartsa számon a tartalék legénységet is, ami kezdetben 0.
	...
	-	A flottához lehessen hozzárendelni tartalék legénységet, aminek bemenõ paramétere egy pozitív egész szám (rendelTartalekLegenyseg). Lehessen lekérdezni az aktuális tartaléklegénységet!
3-as jegyért (SZINT_3)
-	Legénységet lehessen hozzáadni a flotta egy csillagrombolójához a Flotta addLegenyseg metódusával a flottához rendelt tartalék legénység számából.
A metódus a csillagromboló nevét és egy darabszámot vár!
...
-	Legyen a flottának egy checkImmobility metódusa, ami ellenõrzi, hogy a flotta üzemképes-e (minden hajón rendelkezésre áll-e minimális legénység).
Térjen vissza az elsõ olyan hajónak a mutatójával, ami nem üzemképes, vagy nullpointerrel, ha nincs ilyen!
...
-	A Flotta addCsillagromboloChecked metódusa ellenõrizze, hogy a hozzáadandó csillagromboló szerepel-e a flottában!
-	Amennyiben szerepel, a legénységet rendelje hozzá a flottában szereplõ csillagrombolóhoz! Más attribútum ne változzon!
-	Ehhez definiáljon felül egy operator==-t, amivel ellenõrzi két csillagromboló azonosságát! Két csillagromboló azonos, ha ugyanaz a nevük!
-	A csillagrombolókat lehessen std::ostream-re kiíratni! Ugyanígy, egy flotta listázható legyen, az összes csillagromboló felsorolásával!  
A kiíratásban legyen benne a név, aktuális legénység, min. legénység, max. legénység!
*/
